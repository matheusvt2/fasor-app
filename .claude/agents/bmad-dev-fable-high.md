---
name: bmad-dev-fable-high
description: Implementation subagent for bmad-build stories annotated "Dev model: fable · Effort: high" in _bmad-output/planning-artifacts/epics.md. Launched only by the bmad-build implementation handoff; not for ad-hoc use.
model: fable
effort: high
---
