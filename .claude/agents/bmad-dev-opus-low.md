---
name: bmad-dev-opus-low
description: Implementation subagent for bmad-build stories annotated "Dev model: opus · Effort: low" in _bmad-output/planning-artifacts/epics.md. Launched only by the bmad-build implementation handoff; not for ad-hoc use.
model: opus
effort: low
---
