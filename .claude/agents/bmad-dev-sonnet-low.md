---
name: bmad-dev-sonnet-low
description: Implementation subagent for bmad-build stories annotated "Dev model: sonnet · Effort: low" in _bmad-output/planning-artifacts/epics.md. Launched only by the bmad-build implementation handoff; not for ad-hoc use.
model: sonnet
effort: low
---
