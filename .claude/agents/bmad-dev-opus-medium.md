---
name: bmad-dev-opus-medium
description: Implementation subagent for bmad-build stories annotated "Dev model: opus · Effort: medium" in _bmad-output/planning-artifacts/epics.md. Launched only by the bmad-build implementation handoff; not for ad-hoc use.
model: opus
effort: medium
---
