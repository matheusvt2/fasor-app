...
const steps: Step[] = [
  ...
  { kind: 'put', scope: 'relatorio', path: `sheet/${BLOCK_1_ID}/nameplate/fabricante`, value: 'WEG' },
  { kind: 'put', scope: 'relatorio', path: `sheet/${BLOCK_1_ID}/nameplate/fabricante`, value: 'WEG S.A.' },
  { kind: 'put', scope: 'relatorio', path: `sheet/${BLOCK_1_ID}/checklist/limpeza_geral/result`, value: 'C' },
  { kind: 'put', scope: 'relatorio', path: `sheet/${BLOCK_1_ID}/checklist/limpeza_geral/observation`, value: 'Sem observacoes' },
  {
    kind: 'put',
    scope: 'relatorio',
    path: `sheet/${BLOCK_1_ID}/test/isolamento/instrument`,
    value: {
  ...
  { kind: 'put', scope: 'relatorio', path: `sheet/${BLOCK_1_ID}/test/isolamento/cell/0/1`, value: measured('2500', 'MΩ') },
  { kind: 'put', scope: 'relatorio', path: `sheet/${BLOCK_1_ID}/test/isolamento/cell/1/1`, value: measured('3100', 'MΩ') },
  { kind: 'put', scope: 'relatorio', path: `sheet/${BLOCK_1_ID}/test/isolamento/cell/10/2`, value: { raw: '', unit: 'MΩ', state: 'not_measured' } },
  {
    kind: 'put',
    scope: 'relatorio',
    path: `sheet/${BLOCK_1_ID}/test/isolamento/criterion_override`,
  ...
  { kind: 'put', scope: 'relatorio', path: `file/${PHOTO_ID}/reading_status`, value: 'done', server: true, actor: 'system:reading' },
  {
    ...
    value: {
      id: SUGGESTION_1_ID,
      relatorio_id: RELATORIO_ID,
      target_path: `sheet/${BLOCK_1_ID}/nameplate/tensao_primaria`,
      value: '13800',
      trust: 'suggested',
      mode: 'fill',
  ...
  },
  {
    ...
    value: {
      id: SUGGESTION_2_ID,
      relatorio_id: RELATORIO_ID,
      target_path: `sheet/${BLOCK_1_ID}/nameplate/potencia`,
      value: '750',
      trust: 'verify',
      mode: 'fill',
  ...
  { kind: 'put', scope: 'relatorio', path: `sheet/${BLOCK_1_ID}/nameplate/tensao_primaria`, value: '13800', meta: { source_suggestion_id: SUGGESTION_1_ID }, batch_id: BATCH_2_ID },
  ...
  { kind: 'put', scope: 'relatorio', path: `sheet/${BLOCK_1_ID}/nameplate/potencia`, value: '750', meta: { source_suggestion_id: SUGGESTION_2_ID } },
  { kind: 'put', scope: 'relatorio', path: `sheet/${BLOCK_1_ID}/nameplate/potencia`, value: '1000' },
  ...
  },
  {
    ...
    value: { relatorio_id: RELATORIO_ID, revision_number: 1, issued_at: ts(63), seed_version: SEED_VERSION, block_type: 'transformador_forca', fields: { fabricante: 'WEG S.A.', tensao_primaria: '13800', potencia: '1000' } },
    server: true,
    actor: 'system:generate',
  },
